                ...
                <div className="width-100 hometown-section">
                  <form className="entry-form">
                    <div class="form-group">
                        <label className="modal-heading" for="Hometown">Hometown</label>
