              ...
              <div className="flex modal-content-inside">
                ...
                <form className="entry-form">
                  <div class="form-group">
                      <label className="modal-heading" for="college-name">College name</label>
                      <input type="text" id="college-name" placeholder="e.g. St. Stephens" />
                  </div>

                  <div class="form-group">
                      <label className="modal-heading" for="degree">Degree</label>
                      <select id="degree">
                  ...
                  <div class="form-group">
                      <label className="modal-heading" for="specialisation">Specialisation</label>
                  ...
                  <div className="form-group">
                    <label className="modal-heading" for="specialisation">Education Type</label>
                  ...
                  <div class="form-group">
                      <label className="modal-heading" for="start-date">Start date</label>
                  ...
                  <div class="form-group">
                      <label className="modal-heading" for="end-date">End date (or expected)</label>
                      <div class="date-inputs">
                          <select id="end-month">
                              <option value="" disabled selected>Month</option>
                              {/* <!-- Add month options here --> */}
