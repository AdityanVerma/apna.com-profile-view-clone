              ...
              <div className="flex modal-content-inside modal13">
                ...
                <form className="entry-form">
                  <div class="form-group">
                      <label className="modal-heading" for="name">Name</label>
                      <input type="text" id="name" placeholder="Name" />
                  </div>

                  <div class="form-group">
                      <label className="modal-heading" for="gender">Gender</label>
                  ...
                  <div class="form-group">
                      <label className="modal-heading" for="dob">Date of birth</label>
                      <input type="date" id="dob" />
                  </div>

                  <div class="form-group">
                      <label className="modal-heading" for="mobile">Mobile number</label>
                      <input type="tel" id="mobile" placeholder="e.g. +91 0123456789" />
                  </div>

                  <div class="form-group">
                      <label className="modal-heading" for="email">Email Id</label>
